...
function body_lock_add(delay) {
	...
	if (unlock) {
		...
		header.style.paddingRight = window.innerWidth - document.querySelector('html').offsetWidth + 'px';
...
let unlockMenu = document.querySelector('.menu__list');

unlockMenu.addEventListener('click', function () {
   let delay = 0;
   body_lock(delay);
   menu_close();
});
